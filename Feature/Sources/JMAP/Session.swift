...
public struct Session: CustomStringConvertible, Decodable, Equatable, Sendable {
    ...
    public let accounts: [String: SessionAccount]
    ...
    public func primaryAccount(for key: Capability.Key) -> SessionAccount? {
    ...
    public init(from decoder: any Decoder) throws {
        ...
        accounts = try container.decode([String: SessionAccount].self, forKey: .accounts)
